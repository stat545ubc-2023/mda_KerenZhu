...
#visualize
answer1.2.2 <- bind_rows(Q2cleaned, answer2.2_total) %>%
...
output_path <- here::here("output", "summary_table.csv")
write_csv(answer1.2.1,file = output_path, here::here("answer1.2.1.csv"))
```
